 ...
 *  @{
 */
#define __alcd_RS_Config   DDRB      /**< @brief Register to configure the RS pin direction */
#define __alcd_RS_Control  PORTB     /**< @brief Port register to control the RS pin */
#define __alcd_RS_Pin      0         /**< @brief Pin number for the RS pin */

#define __alcd_EN_Config   DDRB      /**< @brief Register to configure the EN pin direction */
#define __alcd_EN_Control  PORTB     /**< @brief Port register to control the EN pin */
...
#define __alcd_DB4_Pin     4         /**< @brief Pin number for the DB4 pin */

#define __alcd_DB5_Config  DDRD      /**< @brief Register to configure the DB5 pin direction */
#define __alcd_DB5_Control PORTD     /**< @brief Port register to control the DB5 pin */
#define __alcd_DB5_Pin     5         /**< @brief Pin number for the DB5 pin */
...
#define __alcd_DB7_Config  DDRD      /**< @brief Register to configure the DB7 pin direction */
#define __alcd_DB7_Control PORTD     /**< @brief Port register to control the DB7 pin */
#define __alcd_DB7_Pin     7         /**< @brief Pin number for the DB7 pin */

/** @brief Backlight Pin Configuration (Optional) */
#ifdef __alcd_useBL
    #define __alcd_BL_Config   DDRB /**< @brief Register to configure the backlight pin direction */
    #define __alcd_BL_Control  PORTB /**< @brief Port register to control the backlight pin */
    #define __alcd_BL_Pin      2    /**< @brief Pin number for the backlight pin */
#endif
/** @} */
