...
#define __alcd_DB0_Config  DDRD     
#define __alcd_DB0_Control PORTD     
#define __alcd_DB0_Pin     0    

#define __alcd_DB1_Config  DDRD     
#define __alcd_DB1_Control PORTD     
#define __alcd_DB1_Pin     1         

#define __alcd_DB2_Config  DDRD      
#define __alcd_DB2_Control PORTD     
#define __alcd_DB2_Pin     2         

#define __alcd_DB3_Config  DDRD     
#define __alcd_DB3_Control PORTD    
#define __alcd_DB3_Pin     3        
